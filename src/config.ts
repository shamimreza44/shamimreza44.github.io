export const siteConfig = {
  ...
  skills: [
    {
      name: "Core Technical & Research Skills",
    ...
    {
      name: "Programming & Computational Skills",
      skills: ["C / C++", "Fortran", "R", "MATLAB", "Python", "Bash scripting", "HTML / CSS / TypeScript"],
    },
    {
      name: "Simulation, ML & Engineering Tools",
    ...
    {
      name: "Systems, Hardware & Industrial Skills",
    ...
    {
      name: "Development & Research Infrastructure",
